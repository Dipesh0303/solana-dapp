...
export type DecrementInput<TAccountTest1 extends string = string> = {
...
>(
  input: DecrementInput<TAccountTest1>,
  config?: { programAddress?: TProgramAddress }
): DecrementInstruction<TProgramAddress, TAccountTest1> {
  // Program address.
  ...
  } as DecrementInstruction<TProgramAddress, TAccountTest1>;
